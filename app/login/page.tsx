...
export const metadata: Metadata = {
  title: "Login | Voyage AI",
  description: "Log in to your Voyage AI account to manage your travel plans.",
};
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12">
          <div className="w-full max-w-md">
            ...
            <div className="mb-12 text-center">
              <p className="text-xs uppercase tracking-[0.3em] text-[#d4a853] mb-3 font-semibold">Welcome Back</p>
              <h1 className="text-4xl sm:text-5xl font-display font-bold text-white mb-4">
                Sign in
              </h1>
              <p className="text-white/50 text-sm">Access your travel plans and exclusive features</p>
            </div>
